 ...
 * DNS-rebinding / cross-site defense for a local GUI — not an authentication
 * layer. The WebServer may bind `0.0.0.0`, but this privileged route passes an
 * empty trust list and deliberately accepts loopback only. Mirrors DSH's
 * `isTrustedApiRequest`.
 */
